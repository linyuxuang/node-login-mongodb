    ...
    methods:{
      ...
      backs(){
          this.$router.go(-1)
               ...
               //注册账户
        test(){
          // 172.28.221.2 服务器电脑ip
         axios.post('http://172.28.221.2/2288', {name:this.username, pass:this.password})
...
            });
        ...
        //登录
       login(){
          axios.get('http://172.28.221.2/logins', {params: { name:this.username,pass:this.password }})
            .then((res)=> {
               if(res.data=='0'){
